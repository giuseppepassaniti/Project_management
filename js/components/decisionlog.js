...
function renderDecisioni(projectId, dataset) {
  const container = document.getElementById('decisioni-section');
  ...
  container.innerHTML = `
    ...
    <p class="mt-2 text-xs text-slate-400">($renderDecisioni - dati limitati)</p>
  `;
}
