...
function renderImprevisti(projectId, dataset) {
  const container = document.getElementById('imprevisti-section');
  ...
  container.innerHTML = `
    ...
    <p class="mt-2 text-xs text-slate-400">($renderImprevisti - dati limitati)</p>
  `;
}
