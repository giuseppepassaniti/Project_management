...
function renderVarianti(projectId, dataset) {
  const container = document.getElementById('varianti-section');
  ...
  container.innerHTML = `
    ...
    <p class="mt-2 text-xs text-slate-400">($renderVarianti - dati limitati)</p>
  `;
}
