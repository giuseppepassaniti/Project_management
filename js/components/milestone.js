...
function renderMilestone(projectId, dataset) {
  const container = document.getElementById('milestone-section');
  ...
  container.innerHTML = `
    ...
    <p class="mt-2 text-xs text-slate-400">($renderMilestone - dati limitati)</p>
  `;
}
